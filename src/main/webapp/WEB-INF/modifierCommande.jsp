					...
					<fieldset class="border rounded border-info ps-4">
						...
						<div id="flexchamp">
							...
							<div class="champ my-2">
								...
								<input class="me-2" type="number" name="dureejours" id="dureejours"
									value="<c:out value =" ${commande.dureeJours}" />">
							...
							<div class="champ my-2">
								<label class="me-2" for="typecommande">Type de Commande<span
										class="requis"></span></label>
								<input class="me-2" type="text" name="typecommande" id="typecommande"
									value="<c:out value =" ${commande.typeCommande}" />" size="20" maxlength="20">
							...
							<div class="champ my-2">
								...
								<select name="clients" id="clients">
									<c:forEach items="${ clients }" var="client">
										<option value="${client.id}" ${commande.client.id==client.id ? 'selected' :'' }>
