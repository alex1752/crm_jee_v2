...
<html>
	...
	<body>
		...
		<c:choose>
			<c:when test="${empty client}"><p>La liste des Clients est vide !</p></c:when>
				 ...
				 <table class="blueTable"> <caption>Liste clients</caption>
		           ...
		           <c:forEach items="${client}" var="client" varStatus="boucle">
		               <tr>
		                   ...
		                   <td> <a href="<c:url value="/SupprimerClient"><c:param name="idClient" value="${client.id}"/></c:url>"><img src="<c:url value ="/assets/croix.png"/>" alt="supprimer"/></a>
